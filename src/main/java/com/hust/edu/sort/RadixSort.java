...
public class RadixSort
{
    ...
    public static void radixSortA( String [ ] arr, int stringLen )
    {
        ...
        ArrayList<String>[] buckets = (ArrayList<String>[]) Array.newInstance(String.class, BUCKETS);
    ...
    public static void radixSort( String [ ] arr, int maxLen )
    {
        ...
        ArrayList<String>[] wordsByLength = (ArrayList<String>[]) Array.newInstance(String.class, maxLen+1);
        ArrayList<String>[] buckets = (ArrayList<String>[]) Array.newInstance(String.class, BUCKETS);
